...
python src/dialogue_synthesis/single_turn/add_thought.py --multi_turn_sample_dir $multi_turn_sample_dir --single_turn_sample_dir $single_turn_sample_dir --num_threads $num_threads
